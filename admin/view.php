...
$kdb=new database("data/FenDb/".$_GET["bsgid"].".db");
...
$selectsql="select * from bsinfo where bs_gid=".$_GET["bsgid"];
$bsi=$kdb->query($selectsql);
$bsf=$bsi->fetchArray();
...
echo "</table>";
?>
<p><button onclick="javascript:location.href='index.php';">返回首页</button></p>
</body>
</html>